...
(define-differentiator (* exp var)
  (simplify
   (simplify (multiplier exp)
             (deriv (multiplicand exp) var))
   (simplify (deriv (multiplier exp) var)
             (multiplicand exp))))
